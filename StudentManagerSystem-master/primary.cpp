...
bool  myCompare1(const primary &a1,const primary &a2)//自定义排序
{
...
void sort_(primary *a)
{
    ...
    cout<<setw(12)<<"| 姓名 |" <<setw(12)<<"|     学号   |"<<setw(12)<<"| 年级 |" <<setw(12)<<"| 班级 |"<<setw(12)<<"| 英语 |" <<setw(12)<<"| 数学 |"<<setw(12)<<"| 语文 |" <<setw(12)<<"| 总分 |"<<setw(12)<<"| 名次 |"<<endl;
    printf("└──────────────────────────────────────────────────────────────────────────────────────────────────────────┘\n");
    for(int i=0; i<primary_num; i++)
    {
...
void sort_1(primary *a)
{
    ...
    cout<<setw(12)<<"| 姓名 |"<<setw(10)<<"| 性别 |" <<setw(12)<<"|     学号   |"<<setw(12)<<"| 年级 |" <<setw(12)<<"| 班级 |"<<setw(12)<<"| 英语 |" <<setw(12)<<"| 名次 |"<<endl;
    printf("└──────────────────────────────────────────────────────────────────────────────────────────────────────────┘\n");
    for(int i=0; i<primary_num; i++)
    {
...
void sort_2(primary *a)
{
    ...
    cout<<setw(12)<<"| 姓名 |"<<setw(10)<<"| 性别 |" <<setw(12)<<"|     学号   |"<<setw(12)<<"| 年级 |" <<setw(12)<<"| 班级 |"<<setw(12)<<"| 语文 |" <<setw(12)<<"| 名次 |"<<endl;
    printf("└──────────────────────────────────────────────────────────────────────────────────────────────────────────┘\n");
    for(int i=0; i<primary_num; i++)
    {
...
void sort_3(primary *a)
{
    ...
    cout<<setw(12)<<"| 姓名 |"<<setw(10)<<"| 性别 |" <<setw(12)<<"|     学号   |"<<setw(12)<<"| 年级 |" <<setw(12)<<"| 班级 |"<<setw(12)<<"| 数学 |" <<setw(12)<<"| 名次 |"<<endl;
    printf("└──────────────────────────────────────────────────────────────────────────────────────────────────────────┘\n");
    for(int i=0; i<primary_num; i++)
    {
...
void  statis(primary *a)
{
    ...
    if(t1=='1')
    {
        cout<<"目前该年级总人数为："<<primary_num<<"人"<<endl;
    }
    else if(t1=='2')
    {
        cout<<"您想查看哪一科的成绩分布："<<endl;
        printf("          ┌———————————————————————————┐\n") ;
        printf("          ║ 英语（1）     语文（2）    数学（3）    总成绩（4）  ║\n");
        printf("          └———————————————————————————┘\n") ;
        cin>>t2;
        if(t2=='1')
        {
...
void edit(primary *a,int n)
{
    ...
    for(int i=0; i<n; i++)
    {
        if(a[i].get_info().id==str)
        {
            ...
            {
                cout<<"选择你要修改的成绩：（1）英语 （2）语文 （3）数学 （4）我全要改"<<endl;
